...
describe('ArtifactPathBuilder', () => {
  ...
  describe('json sidecar paths', () => {
    it('should builds the → .json in the local path', () => {
      const builder = new ArtifactPathBuilder(configMock);
